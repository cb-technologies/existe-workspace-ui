...
import registerLogo from '../../public/note.png';
    ...
    <React.Fragment>
      ...
      >
        <Toolbar sx={{ flexWrap: 'wrap' }}>
          <Typography variant="h6" color="inherit" noWrap sx={{ flexGrow: 1 }} paragraph>
          ...
          {/* <Container maxWidth="sm" component="main">
            ...
            <Typography variant="h6" align="left" color="inherit" component="p">
              name
            </Typography>
          </Container> */}
          <nav>
